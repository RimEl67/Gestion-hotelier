...
namespace Hotel_Management_System.Controllers
{
    public partial class AdminHotelsView : Form
    {
        ...
        {
            query = "DELETE FROM HotelService.Services WHERE BookingId IN (SELECT BookingId FROM Bookings.Booking WHERE HotelId = " + hotelIdField.Text + ")";
            dc.setData(query, "");
        }
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dc.setData(query, "Hotel bookings deleted successfully.");
